...
<html lang="{{ app()->getLocale() }}">
    ...
    <h2>Учим финский язык - вход на сайт</h2>
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form method="POST" action="{{ route('register') }}">
                ...
                <input placeholder="Ваше имя" id="name" type="text" name="name" value="{{ old('name') }}" required autofocus/>
                @if ($errors->has('name'))
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    ...
                    <p>Введите вашу почту и пароль и начнем учить слова</p>
                    <button class="ghost" id="signIn" type="submit">Войти</button>
                </div>
                <div class="overlay-panel overlay-right">
                    <h1>У вас еще нет аккаунта?</h1>
                    <p>Тогда нажимайте на кнопку и регестрируйтесь</p>
